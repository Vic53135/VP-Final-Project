...
def parse_args(argv):
    ...
    parser.add_argument("--checkpoint", default='/home/user/Desktop/Victor/VP_Final_Project/Code/DCAE/checkpoints/0.05/fulldataset/0.05checkpoint_best.pth.tar',type=str, help="Path to a checkpoint")
    parser.add_argument("--data", default='/home/user/Desktop/Victor/VP_Final_Project/Dataset/Dataset/test/kodak',type=str, help="Path to dataset")
