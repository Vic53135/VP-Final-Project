...
def parse_args(argv):
    ...
    # parser.add_argument("--checkpoint", default='/home/user/Desktop/Victor/VP_Final_Project/Code/DCAE_Method_B/checkpoints/0.05/full_dataset/0.05checkpoint_best.pth.tar', type=str, help="Path to a checkpoint")
...
def main(argv):
    ...
    ckpt = torch.load("/home/user/Desktop/Victor/VP_Final_Project/Code/DCAE_Method_B/checkpoints/0.0067/full_dataset/0.0067checkpoint_best.pth.tar", map_location="cpu")
