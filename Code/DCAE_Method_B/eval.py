...
def parse_args(argv):
    ...
    parser.add_argument("--checkpoint", default='/home/user/Desktop/Victor/VP_Final_Project/Code/DCAE_Method_B/checkpoints/0.05/0.05checkpoint_best.pth.tar',type=str, help="Path to a checkpoint")
    parser.add_argument("--data", default='/home/user/Desktop/Victor/VP_Final_Project/Dataset/Dataset/test',type=str, help="Path to dataset")
