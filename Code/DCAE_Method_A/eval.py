...
def parse_args(argv):
    ...
    parser.add_argument("--checkpoint", default='/home/user/Desktop/Victor/VP_Final_Project/Code/checkpoints/0.03/0.03checkpoint_best.pth.tar',type=str, help="Path to a checkpoint")
